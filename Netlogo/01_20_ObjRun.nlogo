...
to Change_color ;; NEW COMMENT: Moving cost is fixed
  ...
  ;; A person who compare the subidy and future loss with moving cost + additional moving cost
  if breed = normals[
    if Government_strategy = "One-time-Subsidy" [
      ...
      if (Total_market_value + MOVING_COST_ADDITION) - Subsidy - Future_loss <= threshold  [
        if moved? = False [
...
<experiments>
  <experiment name="best_Subsidy" repetitions="1" sequentialRunOrder="false" runMetricsEveryStep="false">
    ...
    <steppedValueSet variable="Subsidy" first="0" step="100" last="50000"/>
  </experiment>
</experiments>
@#$#@#$#@
@#$#@#$#@
