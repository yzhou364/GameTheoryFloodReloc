...
; not right
;to setwater
;  foreach gis:feature-list-of ZIPCODES [ vector-feature ->
;    ;gis:paint pcolor cyan
;    set WATER gis:property-value vector-feature "AWATER10"
;    gis:paint pcolor cyan
;  ]
  ;set ZIPCODES gis:load-dataset "data/zipcodes.shp"
  ;foreach gis:feature-list-of ZIPCODES [ vector-feature ->
