  ...
  [
    ...
    [
        ...
        [
          ...
          [
            set Subsidy New_Target_Moved_Rate * SUM_SUBSIDY ;set Subsidy new_Subsidy
...
;  set order_sub sort SUM_SUBSIDY ;; all subsidy needed
...
to Change_color ;; if the moving cost minus the pv of subsidy is less than the future loss, then residents will move ;; ONLY One-time-Subsidy CASE ;;;INDEX MIGHT BE WRONG, FIXED it already
  ...
  [
    ...
    [
      ...
      [ set SUM_SUBSIDY SUM_SUBSIDY + (Total_market_value * Moving_Cost_Multiplier - (item 0 OPP_COST) - Future_loss)]
    ]
  ]
  ...
  [
    ...
    [
      ...
      ;else
      ;[if Moved? = False [ set SUM_SUBSIDY lput (Total_market_value * Moving_Cost_Multiplier - (item 1 OPP_COST) - Future_loss) SUM_SUBSIDY] ]
      ;[if Moved? = False [ set SUM_SUBSIDY insert-item 0 SUM_SUBSIDY (Total_market_value * Moving_Cost_Multiplier - (item 1 OPP_COST) - Future_loss)] ]
      [if Moved? = False [ set SUM_SUBSIDY SUM_SUBSIDY + (Total_market_value * Moving_Cost_Multiplier - (item 1 OPP_COST) - Future_loss) ] ]
    ]
  ]
end
