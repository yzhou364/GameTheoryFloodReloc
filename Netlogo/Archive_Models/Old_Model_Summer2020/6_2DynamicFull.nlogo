...
[
  ...
  TOTAL OPP_COST
  ; Miscellaneous
  MOTIVATED counter_move counter_notmove counter_normalmove counter_normalselfmove counter_poorselfmove counter_poormove counter_normalinf counter_poorinf
...
to Go
  ...
  [
    ...
    [ if Dynamic_Subsidy_Trigger = "Year" or Dynamic_Subsidy_Trigger = "Percentage_Past_Moved"
      [Update_coefficient_SUBSIDY_PV_Dynamic_Y_P]
    ]
...
to Update_coefficient_SUBSIDY_PV_Dynamic
  ...
  [ if any? turtles with [Moved? = true]
    [
      ...
      [ set Subsidy Subsidy - Subsidy_Increment
...
to Update_coefficient_SUBSIDY_PV_Dynamic_Y_P
  if Dynamic_Subsidy?
  [
;    subsidy_calculation
    (ifelse
