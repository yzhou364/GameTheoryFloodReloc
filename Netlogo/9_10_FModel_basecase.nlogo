...
;; the latest version as of 9/10/20
...
;;; Fah's to do: 1 fix relocation cost -> house price + 300k
...
[
  ...
  ;; Miscellaneous list
  TIME GEODATASET CLASS SUM_SUBSIDY MOVE_REACHED? NEW_SUBSIDY ORDER_SUB PERCENTILE REM UB LB SUBSIDY SUBSIDY_CHANGED
]
...
to Update_coefficient_TOTAL ;;; I think the INDEX MIGHT BE WRONG here, so I've adjust the function. This is Fah's version
