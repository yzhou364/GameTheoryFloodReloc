...
to House_property
  foreach gis:feature-list-of GEODATASET [ vector-feature ->
    ...
    if not empty? loc[
      ...
      Setting_agents
      set Subsidy (Total_market_value * Subsidy_percentage)
      ]
    ]
  ]
end
...
@#$#@#$#@
<experiments>
  <experiment name="best_SubsidyPerc_try" repetitions="1" sequentialRunOrder="false" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>OBJECTIVE</metric>
    <steppedValueSet variable="Subsidy_percentage" first="0" step="0.001" last="1"/>
  </experiment>
</experiments>
@#$#@#$#@
@#$#@#$#@
